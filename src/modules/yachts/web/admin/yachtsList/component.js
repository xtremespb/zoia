...
module.exports = class {
    ...
    async onMount() {
        ...
        if (this.input.successNotification) {
            this.getComponent(`yachtsList_mnotify`).func.show(this.i18n.t("dataSaveSuccess"), "is-success");
        }
        await this.loadTree();
    ...
    onActionClick(data) {
        switch (data.action) {
        case "btnEdit":
            setTimeout(() => window.router.navigate("yachts.edit", {
                id: data.id
            }), 10);
            break;
        }
    ...
    onTopButtonClick(obj) {
        ...
        case "btnAdd":
            ...
            window.router.navigate("yachts.edit", {
                id: "new",
                dir: {
                    data,
                    label
