...
module.exports = class {
    ...
    initTree(data, level = 1) {
        return data.map(i => {
            ...
            i.t = i.data && i.data[this.language] && i.data[this.language].title ? i.data[this.language].title : i.data && i.data[this.language] && typeof i.data[this.language] === "string" ? i.data[this.language] : i.data && i.data.title ? i.data.title : i.id;
            if (i.c) {
