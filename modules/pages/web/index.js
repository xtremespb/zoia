...
export default fastify => {
    ...
    fastify.get(fastify.zoiaModulesConfig["pages"].routes.view, pageView(fastify));
    fastify.get(`/:language${fastify.zoiaModulesConfig["pages"].routes.view}`, pageView(fastify));
};
