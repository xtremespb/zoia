...
export default () => ({
    ...
    async handler(req) {
        ...
        const srcDir = req.body.srcDir ? path.resolve(`${__dirname}/../../${req.zoiaConfig.directories.publicImages}/${req.body.srcDir}`).replace(/\\/gm, "/") : root;
        const destDir = req.body.destDir ? path.resolve(`${__dirname}/../../${req.zoiaConfig.directories.publicImages}/${req.body.destDir}`).replace(/\\/gm, "/") : root;
        // Validate form
